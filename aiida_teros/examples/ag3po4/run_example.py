...
"""
Example script for running TEROS workflow for Ag3PO4 ternary oxide system.

This script demonstrates how to set up and run the TEROS workflow for
calculating the surface thermodynamics of Ag3PO4. It can be run in two ways:
...
def run_cli_method():
    ...
    print("=" * 80)
    print("RUNNING TEROS WORKFLOW FOR Ag3PO4 USING CLI METHOD")
    print("=" * 80)
...
def run_api_method():
    ...
    print("=" * 80)
    print("RUNNING TEROS WORKFLOW FOR Ag3PO4 USING PYTHON API METHOD")
    print("=" * 80)
    ...
    inputs = {
        ...
        'total_energy_second_element': Float(config['total_energies']['total_energy_second_element']),
